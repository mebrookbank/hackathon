...
class HorseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Horse entity")
        ...
        .repeat(2) {
            ...
            .post("/api/horses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "horsename":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "ownername":"SAMPLE_TEXT", "locationx":null, "locationy":null, "time":"2020-01-01T00:00:00.000Z", "point":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
